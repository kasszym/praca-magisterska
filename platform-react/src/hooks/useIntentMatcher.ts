...
const intents: Intent[] = [
  ...
  },
  {
    ...
    response_template:
      'Oferujemy następujące opcje dostawy: InPost (1-2 dni, 12.99 zł), FedEx (2-3 dni, 19.99 zł), Poczta Polska (3-5 dni, 9.99 zł).',
    requires_data: false,
  },
  {
    id: 5,
  ...
  },
  {
    ...
    response_template:
      'Wszystkie nasze modele są dostępne od ręki. Mogę pomóc Ci w wyborze odpowiedniego modelu?',
    requires_data: false,
  },
  {
    id: 8,
  ...
  },
  {
    ...
    response_template:
      'Mogę pomóc Ci z informacjami o: cenach, zasięgu, dostępnych kolorach, specyfikacji technicznej i dostępności naszych samochodów. O co chciałbyś zapytać?',
    requires_data: false,
  },
];
